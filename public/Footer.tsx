...
const Footer: FC = () => {
	...
	return (
		<footer
			className={
				styles.footer +
				" px-0 overflow-hidden border-t-4 bg-lightGreyTwo border-orange-two"
			}
		>
				...
				<div className="pt-28 pb-20 flex flex-col items-center justify-between gap-6 px-4 -m-6 md:items-start lg:px-8 lg:flex-row">
					<div className="flex flex-col items-center justify-between w-full lg:w-[35%] py-6 md:py-0 lg:items-start">
						...
						<div className="flex flex-col items-center justify-between w-auto gap-2 py-6 mb-10 lg:items-baseline">
							...
							>
								<div className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-two sm:mr-1">
									<svg
										width="20"
										height="20"
										viewBox="0 0 20 20"
	...
	c0,24.99,20.34,45.33,45.32,45.33c24.99,0,45.32-20.34,45.32-45.33C273.18,202.88,252.85,182.55,227.86,182.55z"
							...
							<div className="flex flex-col sm:flex-row items-start justify-start gap-4">
								<Link href="https://www.crdbbankmarathon.co.tz" target="_black">
									<motion.button
										...
										className={
											styles.borderButton +
											" block group w-[200px] h-[150px] mt-3 relative px-6 py-3 font-semibold tracking-widest text-base sm:mx-0 border-2 border-solid border-orange-two hover:bg-orange-two hover:border-orange-two transition-all ease-in-out duration-500 text-pureBlack hover:text-white before:left-[15%] before:bottom-[-2px] before:block before:h-[2px] before:absolute before:w-[45%] before:content-[''] hover:before:bg-orange-two before:bg-lightGrey after:right-[15%] after:top-[-2px] after:block after:h-[2px] after:absolute after:w-[45%] after:content-[''] after:bg-lightGrey hover:after:bg-orange-two"
										}
									>
										<span>
											<Image
				...
				<div className="border-b border-orange-darker opacity-50" />
							...
							globalContext?.copyrightLinks?.map((item: any, keys: any) => (
								<Fragment key={keys}>
									...
									>
										<Link
											href={`${item?.node?.url}`}
											className="text-pureBlack transition-all duration-200 ease-in-out text-base lg:text-sm hover:text-orange-two"
										>
											{item?.node?.label}
										</Link>
									</motion.li>
