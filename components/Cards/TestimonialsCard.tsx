	...
	return (
		<>
			<motion.div
				...
				whileInView="animate"
				viewport={{once: true}}
				className="p-6 w-full flex flex-col items-center lg:items-baseline gap-6 overflow-hidden mr-8 bg-blue-default border-[5px] border-solid border-lightGreyTwo"
				style={{
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-center">
						...
						<div className={image?.sourceUrl ? "ml-5" : "ml-0"}>
							<span className="block mb-3 text-base text-white font-semibold leading-none">
								{name}
							</span>
							<span className="block text-sm text-white">{position}</span>
						</div>
					</div>
					<motion.div
						initial={initial}
					...
					<Paragraph
						...
						tailwindStyling="text-center lg:text-left text-white text-sm leading-relaxed"
					/>
				</div>
			</motion.div>
		</>
