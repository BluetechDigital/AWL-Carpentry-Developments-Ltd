		...
		<>
			...
			>
				<div className="container relative m-auto flex flex-col items-center gap-6">
					...
					<div className="w-full relative py-20 md:py-24 overflow-hidden">
						<motion.div
							initial={initial}
							variants={stagger}
							whileInView="animate"
						...
						>
							<div className="w-full lg:w-1/3 px-4 mb-15 lg:mb-0">
								<div className="flex flex-wrap -mx-2 lg:flex-col lg:max-w-sm border-b lg:border-b-0 lg:border-r-2 border-blue-default">
									<div className="w-full md:w-1/2 lg:w-full px-2 mb-15">
										<motion.h3
											initial={initial}
											whileInView={fadeInUp}
											viewport={{once: true}}
											className="uppercase text-black text-left font-extrabold text-lg mb-9"
										>
											Getting Started
										</motion.h3>
										<motion.ul
									...
									{selectedItemIndex !== null && (
										<>
											<motion.h3
												...
												whileInView={fadeInUp}
												viewport={{once: true}}
												className="uppercase text-black text-left font-extrabold text-lg mb-6"
											>
